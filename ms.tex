...
\nick{We note that the discrete Wigner representation described in this section is in fact the only non-contextual quasi-probability representation of odd-dimensional stabilizer theories~\cite{schmid2021noncontextual}. In particular, negativity within the Wigner representation cannot be eliminated by considering a different quasi-probability representation. - look at paragraph starting ``In the setting of the full stabilizer subtheory...'' on page 2 of~\cite{schmid2021noncontextual}}
