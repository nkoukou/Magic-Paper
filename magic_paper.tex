...
Using the above results, we can derive the following entropic bound on magic state transformations. \nick{to be extended (1) from unital processes to general relative majorization, (2) from $\alpha = 2m$ to $\alpha = 2m/(2k+1)$ for integer $m,k \geq 0$, (1) from Strange state to any magic state distillation}
