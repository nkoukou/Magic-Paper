...
\begin{align}
\lc{\noisysn}{\frac{1}{d}\id}\left(x_{i'(0, m'_{0}, 9^{s})}\right) &\geq \lc{\rho_{\rm{S}}(\epsilon_{\tau})^{\otimes k}}{\frac{1}{d}\id}\left(x_{i'(0, m'_{0}, 9^{s})}\right), \nonumber\\
\lc{\noisysn}{\frac{1}{d}\id}\left(x_{i'(1, m'_{1}, 9^{s})}\right) &\geq \lc{\rho_{\rm{S}}(\epsilon_{\tau})^{\otimes k}}{\frac{1}{d}\id}\left(x_{i'(1, m'_{1}, 9^{s})}\right), \nonumber\\
&\vdotswithin{=} \nonumber\\
\lc{\noisysn}{\frac{1}{d}\id}\left(x_{i'(r, m'_{r}, 9^{s})}\right) &\geq \lc{\rho_{\rm{S}}(\epsilon_{\tau})^{\otimes k}}{\frac{1}{d}\id}\left(x_{i'(r, m'_{r}, 9^{s})}\right), \nonumber
\end{align}
where $x_{i'(0, m'_{0}, 9^{s'})}, x_{i'(1, m'_{1}, 9^{s'})}, \dots, x_{i'(r, m'_{r}, 9^{s'})} \in T$ are the locations of the elbows of $\lc{\rho_{\rm{S}}(\epsilon')^{\otimes r}}{\frac{1}{d}\id}$ (excluding $0$ and $1$).
