...
Moreover, for the problem of distilling pure magic states where $\epsilon'=0$ we obtain a \nick{lower} bound on the unital fragment distillation rate $R=n/n'$ given by
\begin{equation}
R \geq \frac{\ln (3-4 \epsilon)}{\ln 3},
\end{equation}
which holds for all finite $n$. 
In comparison, the bound from mana gives 
\begin{equation}
	R_{\rm{mana}} \geq \frac{\ln \left(\frac{5}{3} - \frac{8}{9}\epsilon \right)}{\ln \frac{5}{3}},
\end{equation}
a threshold which is lower/looser than the one provided by majorization for all $\epsilon > 0$.

\ddd{[This is good, and the bound coming from the first elbow seems very easy to obtain. Going forward:
\begin{enumerate}
