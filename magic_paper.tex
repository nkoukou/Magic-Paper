...
\begin{equation}\label{eq:rightelb}
	\left( \left(\frac{8}{9}\right)^n \sum\limits_{j=0}^{k'-1} 8^{-(2j+1)} \binom{n}{2j+1}, \left(\frac{4}{3}\right)^n \sum\limits_{j=0}^{k'-1} 4^{-(2j+1)} \binom{n}{2j+1} \right),
\end{equation}
for all elbows right of the maximum, $k' = k_\star, \dots, n$.
