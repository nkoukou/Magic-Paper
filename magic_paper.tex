...
However, it is simple to see that $\zeta$ is always positive. \nick{because it is proportional to $W_{\tau}(0,0)$ and $W_{\tau}(0,0) > 0$ for full-rank, stabilizer $\tau$}
...
\end{equation}
Moreover, the distillation rate $R = m/n$ is bounded as
