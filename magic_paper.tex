...
\subsection{Distillation rate bounds for the unital fragment}\label{sec:lcsu}
...
\begin{align}
	\frac{n'}{n} &\leq \frac{\ln{(3-4\epsilon)}}{\ln{(3-4\epsilon')}}, \\
...
\begin{equation}
R \le \frac{\ln (3-4 \epsilon)}{\ln 3},
\end{equation}
which holds for all finite $n$. In comparison, the bound from mana gives $ R \le $ \ddd{[GIVE VALUE]}.
