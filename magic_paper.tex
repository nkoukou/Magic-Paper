...
\end{equation}
Therefore, in the low temperature scenario $\beta \geq \beta_{\rm{th}}$, the distillation process in~\cref{eq:stdist} is possible only if $L_\star \geq L'_\star$ or equivalently,
\begin{align}
	...
	&= \frac{\ln{\big( \frac{1}{2}-\frac{1}{6}\epsilon' \big)} - \beta F_\beta + \beta E_{\rm{max}}}{\ln{\big( \frac{1}{2}-\frac{1}{6}\epsilon \big)} - \beta F_\beta + \beta E_{\rm{max}}},
\end{align}
