...
This motivates defining the following \emph{Wigner divergence} $D_\infty (W_\rho(\x) || W_\tau (\x))$ on all quantum states. In~\cref{app:lcst_technical}, we show that this divergence has the following natural properties that are derived via relative majorization.
...
We define the $\alpha$--Renyi Wigner divergence $D_\alpha(\p||\r)$ as
\begin{equation}
