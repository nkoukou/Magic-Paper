...
\ddd{[DJ: You've been too sloppy and rushed here. Give the explicit definition of $w'_j$. You've hit a problem almost certainly because you are not handling this technical bit carefully and explicitly - it is crucial, so really unpack it slowly!]} \nick{I don't think it gets more explicit, you just split the line segments uniformly into $d^{2(n-k)}$ segments of length equal to $1/d^{2(n-k)}$ of the total length.}
...
\end{equation}
This is illustrated in~\cref{fig:lc_compare}, where we check the constraint at $x_2 = 0.8025$.
