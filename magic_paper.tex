...
We can reduce this condition to a finite set of inequalities, defined at the elbows of $\lc{\tau}{\sigma}(x)$.
...
Consider now the magic state conversion,
\begin{equation}\label{eq:su_conversion}
	\noisysn \xrightarrow{\E \in \O_{\id/d}} \rho_{\rm{S}}(\epsilon_{\tau})^{\otimes k}.
\end{equation}
The Lorenz curve comparison of these states gives rise to $k$ independent necessary constraints
\begin{align}
...
\end{align}
where $x_1, x_2, \dots, x_k$ are the locations of the elbows of $\lc{\rho_{\rm{S}}(\epsilon_{\tau})^{\otimes k}}{\frac{1}{d}\id}$.
