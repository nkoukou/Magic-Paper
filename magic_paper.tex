...
\begin{equation}
	\eta(\bmx, \bmz) \coloneqq \bmz^T \begin{pmatrix}
		0  & \I \\ %\mathbbm{O}_n  & \id_n \\
		-\I & 0 \\ %-\id_n & \mathbbm{O}_n \\
	\end{pmatrix} \bmx.
\end{equation}
...
\begin{figure}[t!]
    ...
    \caption{\textbf{Bounds on magic distillation rates $R(\beta, \epsilon)$ within stabilizer fragments.}
