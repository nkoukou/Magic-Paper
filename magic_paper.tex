...
In this section, for any non-negative reals $a,b$ with $b\geq a$, we will denote the set of integers $n$ such that $a\leq n \leq b$ as $[a,b]$ for convenience.
...
\begin{proof}
	...
	Bound 3 follows from bound 1 and~\cref{eq:reversephir}. Bound 4 follows from bound x2 and~\cref{eq:reversephir}.
...
\begin{equation}\label{eq:alt_bound}
	\abs{\Phi_\ell^{\rm{alt}}(m; n, p)} \leq \Phi(m; n, p),\ m\in [0,n]
\end{equation}
